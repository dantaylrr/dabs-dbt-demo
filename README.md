...
The 'zoopla' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `zoopla` directory. We recommend making
...
`[dev yourname] zoopla_job` to your workspace.
...
When deploying to this target, note that the default job at resources/zoopla_job.yml
